...
const SPECIAL_CLAIM_TYPES = [
  ...
  { id: 'loss_paired', label: 'Loss of Paired Organ',
    ...
    category: 'Physical Loss & Paired Organs' },
  { id: 'loss_creative', label: 'Loss of Creative Organ (Reproductive)',
    description: 'If you\'ve lost or lost the use of a reproductive organ due to service-connected injury or illness, you qualify for SMC-K. This includes loss of a testicle, ovary, uterus, or penis — whether through surgery, trauma, or loss of function. Erectile dysfunction (ED) also commonly qualifies. This is a flat monthly payment added on top of your regular disability compensation. You can receive more than one SMC-K if multiple organs are affected.',
    category: 'Physical Loss & Paired Organs' },
...
function renderSpecial(){
  ...
  // ── EXTRA MONTHLY PAYMENTS (SMC) — at bottom ──
  html += '<div class="sp-section">';
