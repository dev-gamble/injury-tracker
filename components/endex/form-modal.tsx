export function FormModal() {
  return (
    <div id="form-modal" className="modal-overlay hidden">
      <div className="modal-panel">
        <div className="modal-header">
          <div>
            <div className="ftitle" id="ftitle">
              Log Injury
            </div>
            <div className="fsub" id="fsub">
        ...
        <div className="modal-body">
          {/* Body area field (for custom pins) */}
          <div
            id="body-area-field"
          ...
          <input type="hidden" id="f-sev" defaultValue="moderate" />
          ...
          <div className="field">
            ...
            <select id="f-impact">
              ...
              <option value="Cannot stand for long periods">
                Cannot stand for long periods
              </option>
              <option value="Difficulty lifting objects">
              ...
              <option value="Difficulty bending / kneeling">
                Difficulty bending / kneeling
              </option>
              <option value="Balance problems">Balance problems</option>
              <option value="Anxiety in daily activities">
                Anxiety in daily activities
              </option>
              <option value="Difficulty with personal care">
          ...
          <div className="form-actions">
            <button className="btn-p" id="save-btn">
              Save Injury
            </button>
