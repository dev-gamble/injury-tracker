...
const css = `
  ...
  .cd-card {
    ...
    max-width: 400px;
    overflow: hidden;
    animation: cd-rise 220ms cubic-bezier(0.22, 1, 0.36, 1) both;
  }
...
export function ClearDataModal({ onConfirm, onCancel }: ClearDataModalProps) {
  return (
    <div className="cd-backdrop" onClick={(e) => { if (e.target === e.currentTarget) onCancel() }}>
      <style>{css}</style>
      <div className="cd-card" role="dialog" aria-modal="true" aria-labelledby="cd-title">
        ...
        <div className="cd-body">
          ...
          <div className="cd-icon-wrap">
            <RotateCcw size={22} stroke="#c8102e" strokeWidth={2} />
          </div>

          <h2 className="cd-title" id="cd-title">Reset Session Data</h2>
          <p className="cd-subtitle">
            This will permanently clear all injury entries, conditions, and notes from your current session.
          </p>

          <div className="cd-alert">
            <div className="cd-alert-text">
              <strong>This action cannot be undone</strong>
              All data entered in this session will be erased. Make sure you have exported anything you need before continuing.
            </div>
          </div>
