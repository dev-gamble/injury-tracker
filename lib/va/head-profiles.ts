    ...
    domains: [
      {
        ...
        description: 'Frequency of prostrating attacks — attacks severe enough to leave you completely unable to function.',
        levels: [
          { value: 0,  label: 'Non-prostrating or infrequent',          description: 'Attacks that are not severe enough to leave you unable to function, or infrequent attacks.' },
          { value: 10, label: 'Prostrating attacks ~every 2 months',    description: 'Attacks severe enough to leave you unable to function averaging one in 2 months over last several months.' },
          { value: 30, label: 'Prostrating attacks ~once per month',    description: 'Attacks severe enough to leave you unable to function averaging once a month over last several months.' },
          { value: 50, label: 'Very frequent, severe & prolonged attacks', description: 'Very frequent prostrating attacks, prolonged, causing severe inability to work.' },
        ],
      },
    ],
  },
    ...
    domains: [
      ...
      },
      {
        ...
        levels: [
          ...
          { value: 10,  label: 'Level 1 — Mildly impaired',               description: 'Occasionally unable to handle complex or unfamiliar decisions.' },
          ...
          { value: 100, label: 'Total — Severely impaired',               description: 'Usually unable to make reasonable decisions even for routine or familiar matters.' },
        ],
      },
      {
      ...
      },
      {
        ...
        levels: [
          ...
          { value: 40,  label: 'Level 2 — Mildly decreased',         description: 'Motor activity mildly decreased or with moderate slowing due to apraxia.' },
          { value: 70,  label: 'Level 3 — Moderately decreased',     description: 'Motor activity moderately decreased due to apraxia.' },
          { value: 100, label: 'Total — Severely decreased',         description: 'Motor activity severely decreased due to apraxia.' },
        ],
      },
      {
        id: 'spatial', label: 'Facet 6: Visual Spatial Orientation',
        description: 'Ability to navigate environments and use maps or directions.',
        levels: [
          ...
          { value: 100, label: 'Total — Severely impaired',                  description: 'Unable to find way in familiar places.' },
        ],
      },
      {
        id: 'subjective', label: 'Facet 7: Subjective Symptoms',
        description: 'Headaches, dizziness, fatigue, insomnia, hypersensitivity to sound or light.',
        levels: [
      ...
      },
      {
        ...
        description: 'Ability to communicate by spoken or written language.',
        levels: [
          ...
          { value: 40,  label: 'Level 2 — Impaired less than half the time', description: 'Unable to communicate more than occasionally but less than half the time.' },
          { value: 70,  label: 'Level 3 — Impaired at least half the time', description: 'Unable to communicate at least half the time; may rely on gestures; can communicate basic needs.' },
      ...
      },
      {
        ...
        levels: [
          ...
          { value: 100, label: 'Total — Persistently altered',   description: 'Persistently altered state of consciousness (vegetative state, minimally responsive, coma).' },
        ],
      },
    ],
  },
    ...
    domains: [
      {
        ...
        description: 'Jaw opening range (normal: 35–50 mm).',
        levels: [
          ...
          { value: 30, label: '20 mm or 29–34 mm with restricted diet',       description: '20 mm without restriction; or 29 mm with soft food restriction; or 34 mm with liquid/pureed diet.' },
      ...
      },
      {
        ...
        levels: [
          ...
          { value: 10, label: 'Avoids hard/chewy foods', description: 'Avoids hard, crunchy, or very chewy foods but manages most foods.' },
    ...
    domains: [
      {
        ...
        description: 'Single evaluation whether perceived in one ear, both ears, or head.',
        levels: [
          ...
          { value: 10, label: 'Recurrent; significantly interferes',    description: 'Significantly interferes with sleep, concentration, or daily life; or causes emotional distress.' },
        ],
      },
    ],
  },
    ...
    domains: [
      {
        ...
        levels: [
          ...
          { value: 10, label: 'Ringing only (tinnitus)',       description: 'Ringing, buzzing, or hissing in one or both ears, but hearing is otherwise normal. Note: Tinnitus is rated separately under DC 6260.' },
      ...
      },
      {
        ...
        levels: [
          ...
          { value: 10,  label: 'Mild',                description: 'Difficulty hearing in noisy environments. May need to ask people to repeat.' },
    ...
    domains: [
      {
        ...
        levels: [
          ...
          { value: 100, label: 'Vertigo 5+ times/month or persistent imbalance',    description: 'Vertigo 5+ times/month or persistent balance problems (disequilibrium) and unsteady walking.' },
        ],
      },
    ],
  },
    ...
    domains: [
      {
        ...
        description: 'Frequency of severe and milder sinusitis episodes per year.',
        levels: [
          ...
          { value: 50, label: 'Post-surgical chronic symptoms or near-constant',   description: 'Following radical surgery with chronic bone infection; or near-constant sinusitis.' },
        ],
      },
    ],
  },
    ...
    domains: [
      {
        ...
        description: 'Count how many of these 8 characteristics apply: (1) Scar 5+ inches long, (2) Scar 1/4+ inch wide, (3) Surface contour elevated or depressed, (4) Scar adherent to underlying tissue, (5) Hypo/hyperpigmented area >6 sq in, (6) Abnormal skin texture >6 sq in, (7) Underlying soft tissue missing >6 sq in, (8) Skin indurated and inflexible >6 sq in.',
        levels: [
          { value: 0,  label: 'No characteristics',       description: 'No scars or disfigurement meeting any of the 8 characteristics.' },
          { value: 10, label: '1 characteristic',         description: 'One characteristic of disfigurement present.' },
          { value: 30, label: '2 or 3 characteristics',   description: 'Two or three characteristics; or visible tissue loss with gross distortion or asymmetry of one feature or paired set.' },
          { value: 50, label: '4 or 5 characteristics',   description: 'Four or five characteristics; or visible tissue loss with gross distortion or asymmetry of two features or paired sets.' },
          { value: 80, label: '6 or more characteristics', description: 'Six or more characteristics; or visible tissue loss with gross distortion or asymmetry of three or more features or paired sets.' },
        ],
      },
      {
        ...
        levels: [
          ...
          { value: 30, label: 'Tissue loss with asymmetry of 1 feature',  description: 'Visible or palpable tissue loss AND gross distortion or asymmetry of one feature or paired set of features.' },
...
export const HEAD_CONDITION_PROFILE: Record<string, string> = {
  ...
  'Migraine': 'migraine',
  'TBI residuals': 'tbi',
  'Residuals of Traumatic Brain Injury (TBI)': 'tbi',
  'Cognitive disorder': 'tbi',
  'TMJ disorder': 'tmj',
  'Temporomandibular disorder (TMD)': 'tmj',
  'Tinnitus': 'tinnitus',
  'Tinnitus, recurrent': 'tinnitus',
  'Hearing impairment (hearing loss)': 'hearing',
  'Vertigo / Dizziness': 'vestibular',
  'Peripheral vestibular disorders': 'vestibular',
  "Meniere's syndrome (endolymphatic hydrops)": 'menieres',
  'Vision impairment': 'vision',
  'Diplopia (double vision)': 'vision',
  'Visual field defects': 'vision',
  'Scotoma, unilateral': 'vision',
  'Retinal dystrophy (including retinitis pigmentosa, wet or dry macular degeneration, early-onset macular degeneration, rod and/or cone dystrophy)': 'vision',
  'Diabetic retinopathy': 'vision',
  'Optic neuropathy': 'vision',
  'Ptosis, unilateral or bilateral': 'vision',
  'Post-chiasmal disorders': 'vision',
  'Fifth (trigeminal) cranial nerve, Neuralgia': 'cranial_nerve',
  'Seventh (facial) cranial nerve, Paralysis of': 'cranial_nerve',
  'Sinusitis, chronic': 'sinusitis',
  "Burn scar(s) of the head, face, or neck; scar(s) of the head, face, or neck due to other causes; or other disfigurement of the head, face, or neck": 'disfigurement',
}

export function getHeadProfile(name: string): EvalProfile {
  return HEAD_PROFILES[HEAD_CONDITION_PROFILE[name] ?? 'generic'] ?? HEAD_PROFILES.generic
}
export function getHeadProfileKey(name: string): string {
  return HEAD_CONDITION_PROFILE[name] ?? 'generic'
}
